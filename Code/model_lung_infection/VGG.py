...
class Inf_Net(nn.Module):
    ...
    def forward(self, x):
        ...
        # x5 = torch.cat((self.ra_h1_conv1(x5), F.interpolate(edge_guidance, scale_factor=1 / 16, mode='bilinear')), dim=1)
        # x5 = F.relu(self.ra_h1_conv2(x5))
        # x5 = self.ra_h1_conv3(x5)
        ...
        #        highmap ,final_map,lateral_edge#
        return highmap,lateral_edge,lateral_map_5,lateral_map_4,lateral_map_3,lateral_map_2,lateral_map_1
