...
% ---- 1. ResultMap Path Setting ----  结果图片存储路径
ResultMapPath = '../Results/';
Results = {'Lung infection segmentation','Multi-class lung infection segmentation'};

Models_LungInf = {'UNet','Semi-UNet','Semi-UNet++','Semi-Inf-Net','Semi-mynet_VGG'};
%Models_LungInf = {'VGG+Eg+A4','VGG+Eg+A3','VGG+Eg+A2'};
...
% ---- 2. Ground-truth Datasets Setting ---- GT数据路径
DataPath = '../Dataset/TestingSet/';
%Datasets = {'LungInfection-Test', 'MultiClassInfection-Test'};
Datasets = {'LungInfection-Test'};

% ---- 3. Evaluation Results Save Path Setting ----评价结果存储路径
