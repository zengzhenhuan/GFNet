...
def inference():
    ...
    parser.add_argument('--data_path', type=str, default='./Dataset/TestingSet/covid/',   #测试图片路径
                        help='Path to test data')
    parser.add_argument('--pth_path', type=str, default='./Snapshots/save_weights/Semi-Inf-Net/Inf-Net-100.pth',      #测试权重读取路径
                        help='Path to weights file if `semi-sup`, edit it to `Semi-Inf-Net/Semi-Inf-Net-100.pth`')
    parser.add_argument('--save_path', type=str, default='./Results/Lung infection segmentation/Semi-Inf-Net/',   #测试结果
